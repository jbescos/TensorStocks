...
public class CsvRow implements IRow {
    ...
    public CsvRow(Date date, String symbol, double price, Double avg, Double avg2, int fearGreedIndex,
            Double fearGreedIndexAvg, String token) {
        this.date = date;
        this.symbol = symbol;
        this.price = price;
        this.avg = avg;
    ...
    public String toCsvLine() {
        ...
        builder.append(dateStr).append(",").append(symbol).append(",").append(price).append(",").append(avg).append(",")
                .append(avg2).append(",").append(fearGreedIndex).append(",").append(fearGreedIndexAvg).append(",")
                .append(token).append(Utils.NEW_LINE);
