...
public class Deposit {
	...
	public void calculate(double amount) {
		...
		this.memo = "Transfer " + Utils.format(amount) + currency + " = " + Utils.format(calculatedTotalUsd) + "$. After commission is " + Utils.format(calculatedAfterCommissionTotal) + currency + "=" + Utils.format(calculatedAfterCommissionTotalUsd) + "$";
		LOGGER.info(memo);
	}
}
