...
public class TransactionsSummary {
    ...
    public TransactionsSummary(boolean hasTransactions, double minProfitable, double lowestPurchase, Date lastPurchase,
            List<CsvTransactionRow> previousBuys, List<CsvTransactionRow> previousSells) {
