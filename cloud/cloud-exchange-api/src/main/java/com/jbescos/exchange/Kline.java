...
public class Kline {
    ...
    public Kline(long openTime, String open, String high, String low, String close, String volume, long closeTime,
            String quoteAssetVolume, int numerOfTrades, String takerBuyBaseAssetVolume, String takerBuyQuoteAssetVolume,
            String symbol) {
...
//		OPEN_TIME,CLOSE_TIME,SYMBOL,HIGH,LOW,OPEN,CLOSE,VOLUME,ASSET_VOLUME,SUPPORT_LIST,RESISTANCE_LIST
        StringBuilder builder = new StringBuilder();
        builder.append(openTime).append(",").append(closeTime).append(",").append(symbol).append(",").append(high)
                .append(",").append(low).append(",").append(open).append(",").append(close).append(",").append(volume)
                .append(",").append(quoteAssetVolume).append(",").append(toString(supportList)).append(",")
                .append(toString(resistancetList)).append(Utils.NEW_LINE);
        return builder.toString();
    }
}
