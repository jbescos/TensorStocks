...
public class CsvTransactionRow implements IRow {
    ...
    public CsvTransactionRow(CsvTransactionRow unsynced, String usdt, String quantity, String fee) {
    ...
    public String toString() {
        StringBuilder content = new StringBuilder().append("ORDER ID: ").append(orderId).append("\n").append(symbol)
                .append(" BUY ").append(Utils.fromDate(Utils.FORMAT_SECOND, date))
                .append("\nTotal USD (USD per unit): ").append(usdt).append("$ (").append(Utils.format(usdtUnit, 2))
                .append("$) 💵");
    ...
    public String toCsvLine() {
        ...
        data.append(Utils.fromDate(Utils.FORMAT_SECOND, date)).append(",").append(orderId).append(",")
                .append(side.name()).append(",").append(symbol).append(",").append(usdt).append(",").append(quantity)
                .append(",").append(Utils.format(usdtUnit));
        data.append(",").append(Utils.format(score));
        data.append(",").append(sync);
        data.append(",").append(fee);
        data.append("\r\n");
